...
export default function OrderModal({ open, handleClose, handleUpdate, btnClr, text }) {
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 z-10">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <button
                            ...
                            data-modal-hide="popup-modal" type="button" class={btnClr + " text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"}>
                            Yes, I'm sure
                        </button>
                        <button
                            onClick={handleClose}
                            data-modal-hide="popup-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, go back</button>
                    </div>
                </div>
            </Box>
        </Modal>
