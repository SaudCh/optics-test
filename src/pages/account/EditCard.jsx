...
function EditCard() {
     ...
     <div className="py-3 flex flex-row justify-between flex-wrap ">
          <div className="flex flex-row">
            ...
            <div className="flex flex-col justify-between ml-4">
              ...
              <select id="sizes" className="bg-gray-100 shadow  text-gray-600 text-xs py-2 px-1 ">
  ...
  <option value="DE">Extra Large</option>
        ...
        <div className="flex flex-col justify-between mr-16 ">
            <span className="uppercase text-xs font-medium text-gray-500">Price</span>
            <span className="uppercase text-xs font-medium text-gray-500">Art.nr</span>
            <span className="uppercase text-xs font-medium text-gray-500">Qty</span>
          </div>

          <div className="flex flex-col justify-between">
            <span className="uppercase text-xs font-medium text-gray-600">Rs 1000.00</span>
            <span className="uppercase text-xs font-medium text-gray-600">112456</span>
